...
public class SimpleUploadTask extends BaseOssTask {
    ...
    public void upload2OssByPartition(OSS oss) {
        ...
        InitiateMultipartUploadResult initMultipartUpload;
        long j;
        try {
            initMultipartUpload = oss.initMultipartUpload(new InitiateMultipartUploadRequest(bucketRootName(), this.mRemoteObjectKey));
